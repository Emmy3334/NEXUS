...
pub(crate) fn prepare_child_command(_command: &mut Command) {}

pub(crate) fn prepare_background_group(_command: &mut Command) {}

pub(crate) fn prepare_process_group(_command: &mut Command, _pgid: Option<i32>) {}
